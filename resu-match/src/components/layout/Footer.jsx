                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
                    ...
                    <div className="lg:col-span-2">
                        <Link to="/" className="flex items-center gap-3 group mb-4">
                            <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center text-white font-bold text-xl shadow-lg group-hover:scale-110 transition-all duration-300">
                                R
                            </div>
                            <div className="flex flex-col">
                                ...
                                <span className="text-sm text-blue-200 -mt-1 font-medium">
                                    Pakistan
                                </span>
                            </div>
                        </Link>
                        <p className="text-blue-100 mb-6 text-sm leading-relaxed max-w-sm">
                            Pakistan's leading job platform connecting talented professionals with top companies 
                        ...
                        <div className="flex gap-4">
                            {socialLinks.map(social => (
                                <a
                                    key={social.name}
                                    href={social.url}
                                    className="w-10 h-10 bg-blue-800 hover:bg-blue-600 rounded-lg flex items-center justify-center text-blue-200 hover:text-white transition-all duration-300 cursor-pointer"
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                        <p className="text-sm text-blue-100">
                            © {currentYear} ResuMatch Pakistan. All rights reserved.
                        </p>
