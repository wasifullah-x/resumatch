...
export default function Navbar() {
    ...
    const navLinks = [
        ...
        { path: '/advice', label: 'Career Advice' },
        ...(isAuthenticated ? [
                                    ...
                                    <>
                                        ...
                                        <div className="absolute right-0 mt-2 w-56 card p-2 shadow-hard animate-scaleIn">
                                            ...
                                            <Link
                                                ...
                                                className="flex items-center gap-3 px-4 py-3 text-sm text-purple-700 rounded-lg hover:bg-purple-50 transition-colors cursor-pointer"
                                                onClick={() => setIsUserMenuOpen(false)}
                                            >
                                                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
